...
import edu.arizona.cs.hsynth.hadoop.io.HSynthBloomMapFile;
...
public class HSynthBloomMapFileOutputFormat extends HSynthFileOutputFormat<WritableComparable<?>, Writable> {
     ...
     */
    public static HSynthBloomMapFile.Reader[] getReaders(HSynthFSPath dir,
        ...
        HSynthFSPath[] names = fs.listAllFiles(dir);
