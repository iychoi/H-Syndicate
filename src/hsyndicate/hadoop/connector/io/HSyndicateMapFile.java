 ...
 * the License.
 */
package hsyndicate.hadoop.connector.io;

import hsyndicate.fs.SyndicateFSPath;
import hsyndicate.fs.AHSyndicateFileSystemBase;
import hsyndicate.hadoop.connector.io.HSyndicateSequenceFile.CompressionType;
import java.io.*;
 ...
 * SequenceFile.Sorter}.
 */
public class HSyndicateMapFile {

    private static final Log LOG = LogFactory.getLog(HSyndicateMapFile.class);
    /**
    ...
    public static class Writer implements java.io.Closeable {
        ...
        private HSyndicateSequenceFile.Writer data;
        private HSyndicateSequenceFile.Writer index;
        ...
        public Writer(Configuration conf, AHSyndicateFileSystemBase fs, String dirName,
            ...
            this(conf, fs, dirName,
                    ...
                    HSyndicateSequenceFile.getCompressionType(conf));
        }
        ...
        public Writer(Configuration conf, AHSyndicateFileSystemBase fs, String dirName,
            ...
            this.data =
                    HSyndicateSequenceFile.createWriter(fs, conf, dataFile, keyClass, valClass, compress, codec, progress);
            this.index =
                    HSyndicateSequenceFile.createWriter(fs, conf, indexFile, keyClass, LongWritable.class,
    ...
    public static class Reader implements java.io.Closeable {
        ...
        // the data, on disk
        private HSyndicateSequenceFile.Reader data;
        private HSyndicateSequenceFile.Reader index;
        ...
        protected synchronized void open(AHSyndicateFileSystemBase fs, String dirName,
            ...
            // open the index
            this.index = new HSyndicateSequenceFile.Reader(fs, indexFile, conf);
        }
...
-
    ...
    public static long fix(AHSyndicateFileSystemBase fs, SyndicateFSPath dir,
        ...
        HSyndicateSequenceFile.Reader dataReader = new HSyndicateSequenceFile.Reader(fs, data, conf);
        ...
        HSyndicateSequenceFile.Writer indexWriter = null;
        if (!dryrun) {
            indexWriter = HSyndicateSequenceFile.createWriter(fs, conf, index, keyClass, LongWritable.class);
        }
        try {
            long pos = 0L;
            LongWritable position = new LongWritable();
