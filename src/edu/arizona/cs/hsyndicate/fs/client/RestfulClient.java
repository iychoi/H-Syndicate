...
public class RestfulClient {
    ...
    public Object processPost(Future<ClientResponse> future, GenericType<?> generic) throws IOException {
        if(future == null) {
    ...
    public Object processGet(Future<ClientResponse> future, GenericType<?> generic) throws IOException, FileNotFoundException {
        if(future == null) {
            throw new IllegalArgumentException("future is null");
        }
    ...
    public Object processDelete(Future<ClientResponse> future, GenericType<?> generic) throws IOException, FileNotFoundException {
        if(future == null) {
            throw new IllegalArgumentException("future is null");
        }
    ...
    public InputStream processDownload(Future<ClientResponse> future) throws IOException, FileNotFoundException {
        if(future == null) {
            throw new IllegalArgumentException("future is null");
        }
