 ...
 */
public class HSynthBloomMapFile {

    private static final Log LOG = LogFactory.getLog(HSynthBloomMapFile.class);
    ...
    public static class Writer extends HSynthMapFile.Writer {
    ...
    public static class Reader extends HSynthMapFile.Reader {
