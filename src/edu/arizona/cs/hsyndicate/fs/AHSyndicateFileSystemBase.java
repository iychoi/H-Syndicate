...
public abstract class AHSyndicateFileSystemBase implements Closeable {
    ...
    public abstract void truncate(SyndicateFSPath path, long offset) throws FileNotFoundException, IOException;
    ...
    private synchronized String getLocalCachedBlocksInString(SyndicateFSPath path) throws FileNotFoundException, IOException {
        return getExtendedAttr(path, LOCAL_CACHED_BLOCKS_XATTR_NAME);
    }
    
    public synchronized String getLocalCachePath(SyndicateFSPath path) throws FileNotFoundException, IOException {
