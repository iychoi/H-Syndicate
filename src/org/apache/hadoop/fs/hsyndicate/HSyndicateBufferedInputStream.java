...
public class HSyndicateBufferedInputStream extends FSInputStream {
    
    private static final Log LOG = LogFactory.getLog(HSyndicateBufferedInputStream.class);
    ...
    private HSyndicateInputStream is;
    
    public HSyndicateBufferedInputStream(HSyndicateInputStream is) throws IOException {
        init(is, HSyndicateConfigUtils.DEFAULT_BUFFER_SIZE);
    }
    
    public HSyndicateBufferedInputStream(HSyndicateInputStream is, int buffer_size) throws IOException {
        init(is, buffer_size);
    }
    
    private void init(HSyndicateInputStream is, int buffer_size) throws IOException {
        this.is = is;
