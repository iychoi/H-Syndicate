...
import hsyndicate.hadoop.connector.io.HSyndicateBloomMapFile;
...
public class HSyndicateBloomMapFileOutputFormat extends HSyndicateFileOutputFormat<WritableComparable<?>, Writable> {
    ...
    public RecordWriter<WritableComparable<?>, Writable> getRecordWriter(
        ...
        final HSyndicateBloomMapFile.Writer out =
                new HSyndicateBloomMapFile.Writer(conf, fs, file.toString(),
    ...
    public static HSyndicateBloomMapFile.Reader[] getReaders(SyndicateFSPath dir,
        ...
        HSyndicateBloomMapFile.Reader[] parts = new HSyndicateBloomMapFile.Reader[names.length];
        for (int i = 0; i < names.length; i++) {
            parts[i] = new HSyndicateBloomMapFile.Reader(fs, names[i].toString(), conf);
        }
        return parts;
    }
     ...
     */
    public static <K extends WritableComparable<?>, V extends Writable> Writable getEntry(HSyndicateBloomMapFile.Reader[] readers,
