...
/**
 * HSynthFilterOutputFormat is a convenience class that wraps OutputFormat.
 */
public class HSynthFilterOutputFormat<K, V> extends OutputFormat<K, V> {

    protected OutputFormat<K, V> baseOut;

    public HSynthFilterOutputFormat() {
        this.baseOut = null;
    }

    /**
     * Create a HSynthFilterOutputFormat based on the underlying output format.
     *
     * @param baseOut the underlying OutputFormat
     */
    public HSynthFilterOutputFormat(OutputFormat<K, V> baseOut) {
