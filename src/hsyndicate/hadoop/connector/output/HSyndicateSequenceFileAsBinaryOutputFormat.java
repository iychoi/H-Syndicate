...
import hsyndicate.hadoop.connector.io.HSyndicateSequenceFile;
import hsyndicate.hadoop.connector.io.HSyndicateSequenceFile.CompressionType;
import hsyndicate.hadoop.connector.io.HSyndicateSequenceFile.ValueBytes;
...
/**
 * An {@link org.apache.hadoop.mapreduce.OutputFormat} that writes keys, values
 * to {@link SequenceFile}s in binary(raw) format
 */
public class HSyndicateSequenceFileAsBinaryOutputFormat
        extends HSyndicateSequenceFileOutputFormat<BytesWritable, BytesWritable> {
    ...
    public RecordWriter<BytesWritable, BytesWritable> getRecordWriter(
        ...
        final HSyndicateSequenceFile.Writer out = getSequenceWriter(context,
    ...
    protected HSyndicateSequenceFile.Writer getSequenceWriter(TaskAttemptContext context,
        ...
        return HSyndicateSequenceFile.createWriter(fs, conf, file,
                keyClass,
                valueClass,
                compressionType,
                codec,
    ...
    @Override
    public void checkOutputSpecs(JobContext job) throws IOException, FileAlreadyExistsException, InterruptedException {
