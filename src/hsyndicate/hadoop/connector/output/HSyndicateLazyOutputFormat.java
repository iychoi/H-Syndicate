 ...
 */
public class HSyndicateLazyOutputFormat<K, V> extends HSyndicateFilterOutputFormat<K, V> {

    public static String OUTPUT_FORMAT
            = "mapreduce.output.lazyoutputformat.outputformat";

    /**
     * Set the underlying output format for HSyndicateLazyOutputFormat.
     *
    ...
    public static void setOutputFormatClass(Job job,
        ...
        job.setOutputFormatClass(HSyndicateLazyOutputFormat.class);
    ...
    /**
     * A convenience class to be used with HSyndicateLazyOutputFormat
     */
