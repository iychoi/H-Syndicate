...
import hsyndicate.hadoop.connector.input.HSyndicateFSDataInputStream;
import hsyndicate.hadoop.connector.input.HSyndicateFSSeekableInputStream;
import hsyndicate.hadoop.connector.io.HSyndicateSequenceFile.CompressionType;
import hsyndicate.hadoop.connector.output.HSyndicateFSDataOutputStream;
 ...
 */
public class HSyndicateBloomMapFile {

    private static final Log LOG = LogFactory.getLog(HSyndicateBloomMapFile.class);
    ...
    public static class Writer extends HSyndicateMapFile.Writer {
        ...
        public synchronized void close() throws IOException {
            super.close();
            DataOutputStream out = new HSyndicateFSDataOutputStream(fs.getFileOutputStream(new SyndicateFSPath(dir, BLOOM_FILE_NAME)));
    ...
    public static class Reader extends HSyndicateMapFile.Reader {
