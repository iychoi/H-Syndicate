...
import edu.arizona.cs.hsynth.hadoop.connector.output.HSynthFSDataOutputStream;
import java.io.*;
import java.util.*;
...
/**
 * <code>HSynthSequenceFile</code>s are flat files consisting of binary
 * key/value pairs.
 *
 * <p><code>HSynthSequenceFile</code> provides {@link Writer}, {@link Reader}
 * and {@link Sorter} classes for writing, reading and sorting respectively.</p>
 *
 * There are three
 * <code>HSynthSequenceFile</code>
 ...
 * provided by the
 * <code>HSynthSequenceFile</code> to chose the preferred format.</p>
 *
 * <p>The {@link Reader} acts as the bridge and can read any of the above
 * <code>HSynthSequenceFile</code> formats.</p>
 *
 * <h4 id="Formats">HSynthSequenceFile Formats</h4>
 *
 * <p>Essentially there are 3 different formats for
 * <code>HSynthSequenceFile</code>s depending on the
 * <code>CompressionType</code> specified. All of them share a
 * <a href="#Header">common header</a> described below.
 *
 * <h5 id="Header">HSynthSequenceFile Header</h5>
 * <ul>
 * <li>
 ...
 * </ul>
 *
 * <h5 id="#UncompressedFormat">Uncompressed HSynthSequenceFile Format</h5>
 * <ul>
 * <li>
 ...
 * </ul>
 *
 * <h5 id="#RecordCompressedFormat">Record-Compressed HSynthSequenceFile
 * Format</h5>
 * <ul>
 * <li>
 * <a href="#Header">Header</a>
 ...
 * </ul>
 *
 * <h5 id="#BlockCompressedFormat">Block-Compressed HSynthSequenceFile
 * Format</h5>
 * <ul>
 * <li>
 * <a href="#Header">Header</a>
 ...
 */
public class HSynthSequenceFile {

    private static final Log LOG = LogFactory.getLog(HSynthSequenceFile.class);

    private HSynthSequenceFile() {
    }                         // no public ctor
     ...
     * {@link HSynthSequenceFile}.
     *
     * @see HSynthSequenceFile.Writer
     */
     ...
     * @deprecated Use the one of the many HSynthSequenceFile.createWriter
     * methods to specify the {@link CompressionType} while creating the
     * {@link HSynthSequenceFile} or
     * {@link org.apache.hadoop.mapred.SequenceFileOutputFormat#setOutputCompressionType(org.apache.hadoop.mapred.JobConf, org.apache.hadoop.io.HSynthSequenceFile.CompressionType)}
    ...
    /**
     * Construct the preferred type of HSynthSequenceFile Writer.
     *
     ...
     * @return Returns the handle to the constructed HSynthSequenceFile Writer.
     * @throws IOException
     */
    public static Writer createWriter(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
    ...
    public static Writer createWriter(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
        ...
        HSynthFSDataOutputStream fsos = new HSynthFSDataOutputStream(fs.getFileOutputStream(name));
    ...
    /**
     * Construct the preferred type of 'raw' HSynthSequenceFile Writer.
     *
     ...
     * @throws IOException
     */
    private static Writer createWriter(Configuration conf, HSynthFSDataOutputStream out,
     ...
     * @throws IOException
     */
    private static Writer createWriter(HSynthFileSystem fs, Configuration conf, HSynthFSPath file,
            Class keyClass, Class valClass,
     ...
     * @throws IOException
     */
    public static Writer createWriter(Configuration conf, HSynthFSDataOutputStream out,
            Class keyClass, Class valClass, CompressionType compressionType,
            CompressionCodec codec, Metadata metadata)
            throws IOException {
        if ((codec instanceof GzipCodec)
    ...
    public static class Writer implements java.io.Closeable {
         ...
         */
        public Writer(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
                Class keyClass, Class valClass)
                throws IOException {
        ...
        public Writer(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
                ...
                throws IOException {
            init(name, conf,
                    new HSynthFSDataOutputStream(fs.getFileOutputStream(name)),
         ...
         */
        Writer(Configuration conf, HSynthFSDataOutputStream out,
        ...
        void init(HSynthFSPath name, Configuration conf, HSynthFSDataOutputStream out,
                Class keyClass, Class valClass,
         ...
         * {@link HSynthSequenceFile.Reader#seek(long)} with a position returned
         * by this method, {@link HSynthSequenceFile.Reader#next(Writable)} may
    ...
    static class RecordCompressWriter extends Writer {
         ...
         * Create the named file.
         */
        public RecordCompressWriter(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
                Class keyClass, Class valClass, CompressionCodec codec)
                throws IOException {
            this(conf, new HSynthFSDataOutputStream(fs.getFileOutputStream(name)), keyClass, valClass, codec, new Metadata());
        }
         ...
         * Write to an arbitrary stream using a specified buffer size.
         */
        RecordCompressWriter(Configuration conf, HSynthFSDataOutputStream out,
    ...
    static class BlockCompressWriter extends Writer {
         ...
         * Create the named file.
         */
        public BlockCompressWriter(HSynthFileSystem fs, Configuration conf, HSynthFSPath name,
                Class keyClass, Class valClass, CompressionCodec codec)
                throws IOException {
         ...
         * Write to an arbitrary stream using a specified buffer size.
         */
        BlockCompressWriter(Configuration conf, HSynthFSDataOutputStream out,
                Class keyClass, Class valClass, CompressionCodec codec, Metadata metadata)
                throws IOException {
            this.ownOutputStream = false;
            super.init(null, conf, out, keyClass, valClass, true, codec, metadata);
    ...
    public static class Reader implements java.io.Closeable {
        ...
        private HSynthFSPath file;
        private HSynthFSDataInputStream in;
         ...
         * Open the named file.
         */
        public Reader(HSynthFileSystem fs, HSynthFSPath file, Configuration conf)
                throws IOException {
            this(fs, file, conf, false);
        }

        private Reader(HSynthFileSystem fs, HSynthFSPath file,
                Configuration conf, boolean tempReader) throws IOException {
            this(fs, file, 0, fs.getSize(file), conf, tempReader);
        }

        private Reader(HSynthFileSystem fs, HSynthFSPath file, long start,
         ...
         */
        protected HSynthFSDataInputStream openFile(HSynthFileSystem fs, HSynthFSPath file,
                long length) throws IOException {
            return new HSynthFSDataInputStream(new HSynthFSSeekableInputStream(fs.getRandomAccess(file)));
        }
         ...
         * reader {@link HSynthSequenceFile.Sorter.cloneFileAttributes}, and
        ...
        /**
         * @deprecated Call
         * {@link #nextRaw(DataOutputBuffer,HSynthSequenceFile.ValueBytes)}.
         */
         ...
         * HSynthSequenceFile.Writer#getLength()} when writing this file. To
         * seek to an arbitrary position, use
         * {@link HSynthSequenceFile.Reader#sync(long)}.
         */
