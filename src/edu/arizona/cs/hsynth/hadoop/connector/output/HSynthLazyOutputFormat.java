 ...
 */
public class HSynthLazyOutputFormat <K,V> extends HSynthFilterOutputFormat<K, V> {
  public static String OUTPUT_FORMAT = 
    "mapreduce.output.lazyoutputformat.outputformat";
  /**
   * Set the underlying output format for HSynthLazyOutputFormat.
  ...
  public static void  setOutputFormatClass(Job job, 
      ...
      job.setOutputFormatClass(HSynthLazyOutputFormat.class);
  ...
  /**
   * A convenience class to be used with HSynthLazyOutputFormat
   */
