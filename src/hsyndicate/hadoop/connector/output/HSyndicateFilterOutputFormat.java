...
/**
 * HSyndicateFilterOutputFormat is a convenience class that wraps OutputFormat.
 */
public class HSyndicateFilterOutputFormat<K, V> extends OutputFormat<K, V> {

    protected OutputFormat<K, V> baseOut;

    public HSyndicateFilterOutputFormat() {
        this.baseOut = null;
    }

    /**
     * Create a HSyndicateFilterOutputFormat based on the underlying output format.
     *
     * @param baseOut the underlying OutputFormat
     */
    public HSyndicateFilterOutputFormat(OutputFormat<K, V> baseOut) {
    ...
    /**
     * <code>FilterRecordWriter</code> is a convenience wrapper class that
